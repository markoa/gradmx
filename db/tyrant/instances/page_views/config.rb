...
Loquacious::Configuration.for( "page_views" ) do
  ...
  txt
  replication_timestamp_file "page_views.rts"
  ...
  txt
  lua_extension_file "lua/page_views.lua"
...
if $0 == __FILE__ then
  help = Loquacious::Configuration.help_for("page_views", :colorize => true)
