...
Loquacious::Configuration.for( "presences" ) do
  ...
  txt
  replication_timestamp_file "presences.rts"
  ...
  txt
  lua_extension_file "lua/presences.lua"
...
if $0 == __FILE__ then
  help = Loquacious::Configuration.help_for("presences", :colorize => true)
